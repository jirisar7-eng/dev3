...
class MemoryStore {
  ...
  subjekty: Subjekt[] = [
    ...
    },
    {
      id: 'subj-8',
      type: 'ZNALEC',
      name: 'PhDr. Alena Malá',
      titleBefore: 'PhDr.',
      position: 'Soudní znalec - pedopsychologie a klinická psychologie dětí',
      institution: 'Znalecká ambulance dětské psychologie',
      city: 'České Budějovice',
      region: 'Jihočeský kraj',
      address: 'Lannova třída 63/14, 370 01 České Budějovice',
      email: 'mala.znalec@psychologie-cb.cz',
      phone: '+420 386 352 147',
      website: 'https://www.psychologie-cb.cz',
      lat: 48.9745,
      lng: 14.4789,
      avgRating: 4.7,
      reviewCount: 5,
    ...
    },
    {
      id: 'subj-9',
      type: 'ADVOKAT',
      name: 'Mgr. Petr Novotný',
      titleBefore: 'Mgr.',
      position: 'Samostatný advokát pro rodinné spory',
      institution: 'Advokátní kancelář Novotný',
      city: 'Hradec Králové',
      region: 'Královéhradecký kraj',
      address: 'Velké náměstí 138, 500 03 Hradec Králové',
      email: 'novotny@ak-novotny.cz',
      phone: '+420 495 512 890',
