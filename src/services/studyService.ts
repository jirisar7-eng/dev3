    ...
    if (prisma) {
      try {
        ...
        return studies.map((s) => ({
          ...
          evidenceDirection: s.evidenceDirection,
    ...
    if (prisma) {
      try {
        ...
        return {
          ...
          evidenceLevel: created.evidenceLevel,
          evidenceDirection: created.evidenceDirection,
          causality: created.causality,
    ...
    if (prisma) {
      try {
        ...
        return {
          ...
          evidenceDirection: updated.evidenceDirection,
          causality: updated.causality,
