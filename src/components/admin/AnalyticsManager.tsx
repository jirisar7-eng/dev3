    ...
    <div className="space-y-6">
      ...
      {activeTab === 'overview' && real && (
        <div className="space-y-6">
          ...
          <div className="bg-white text-slate-900 rounded-3xl p-6 border border-slate-200 shadow-md">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4 pt-4 border-t border-slate-200 text-xs">
              <div>
