        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <MarkdownEditor
                label="Obsah poznámky / Strategický text *"
                required
                value={content}
                onChange={setContent}
                rows={6}
          ...
          {filteredNotes.map((note) => (
            ...
            >
              <div>
                ...
                <div className="mt-3 text-xs text-slate-700 leading-relaxed bg-slate-50/70 p-3.5 rounded-2xl border border-slate-100 font-normal prose prose-slate max-w-none prose-headings:font-bold prose-h2:text-sm prose-h3:text-xs prose-a:text-blue-700">
