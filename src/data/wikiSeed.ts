...
export const DEFAULT_WIKI_TERMS: WikiTerm[] = [
  ...
  },
  {
    ...
    definition: 'Zákonná povinnost rodičů zabezpečit výživu a výchovu svých dětí. Zásadním pravidlem je princip shodné životní úrovně dítěte a rodičů (§ 915 odst. 1 o.z.). Vyživovací povinnost trvá do doby, než je dítě schopno se samo živit.',
    practicalTips: [
    ...
    seoDescription: 'Zákonná vyživovací povinnost, princip shodné životní úrovně a stanovení výživného soudem.',
