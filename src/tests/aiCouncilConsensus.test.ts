...
export async function runAICouncilConsensusTests() {
  ...
  orchestrator.registerProvider(new MockCouncilProvider('gemini', 'gemini-1.5-flash', 'FAIL'));
  orchestrator.registerProvider(new MockCouncilProvider('grok', 'grok-2', 'FAIL'));
