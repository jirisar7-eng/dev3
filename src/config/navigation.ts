...
export const NAVIGATION_ITEMS: NavItem[] = [
  ...
  // Category 3: 💼 Spis & Správa účtu
  { id: 'cat-3', labelKey: '💼 Spis & Správa účtu', url: '/muj-pripad', order: 30, target: '_self', isExternal: false },
  { id: 'sub-3-1', labelKey: 'Osobní spis otce (Právní agenda)', url: '/muj-pripad', order: 31, target: '_self', isExternal: false, parentId: 'cat-3' },
  { id: 'sub-3-2', labelKey: '👨‍👧 Péče o dítě', url: '/pece', order: 32, target: '_self', isExternal: false, parentId: 'cat-3' },
  { id: 'sub-3-3', labelKey: 'CoParent Hub (Spolurodičovství)', url: '/portal/coparent', order: 33, target: '_self', isExternal: false, parentId: 'cat-3' },
  { id: 'sub-3-4', labelKey: 'Můj Profil (Správa účtu)', url: '/portal/profil', order: 34, target: '_self', isExternal: false, parentId: 'cat-3' },
