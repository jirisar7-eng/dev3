...
import { Heart, Building2, ChevronRight, Users, Sparkles, HandHeart, ShieldCheck, Scale } from 'lucide-react';
            ...
            <div className="bg-slate-900 rounded-[2rem] p-8 sm:p-10 shadow-xl shadow-slate-900/20 border border-slate-800 flex flex-col relative overflow-hidden group">
              ...
              <div className="relative z-10 mt-auto">
                <button 
                  ...
                  className="w-full bg-indigo-500 hover:bg-indigo-400 text-white py-4 rounded-xl font-bold text-sm transition-colors shadow-lg shadow-indigo-900/50 flex items-center justify-center gap-2"
                >
