...
1.  **Všechny prvky jsou reálně integrované (100% PASS):** Žádný prvek není fiktivní, simulovaný, nebo přítomný pouze v dřívější dokumentaci. Všechny informace se reálně vykreslují na odpovídajících front-endových pohleduch.
