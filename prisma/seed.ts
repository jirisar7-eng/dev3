      ...
      for (const study of dbStore.studies) {
        await prisma.study.upsert({
          ...
          update: {
            ...
            evidenceLevel: study.evidenceLevel || 'B',
            evidenceDirection: study.evidenceDirection || 'SUPPORTIVE',
            causality: study.causality || 'NOT_ESTABLISHED',
            sourceType: study.sourceType || 'PEER_REVIEWED_EMPIRICAL',
